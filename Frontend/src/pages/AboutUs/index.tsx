    ...
    <div className={styles.AboutUsContainer}>
      ...
      <main className={styles.aboutUsMain}>
        ...
        <section className={styles.pilarsSection}>
          ...
          <PilarsCard iconLink={Visao} title='Visão' text='Temos como visão nos tornar o maior website de filmes do mundo até 2025'/>
          <PilarsCard iconLink={Valores} title='Valores' text='Trabalhamos com integridade, humildade e criatividade para o cliente'/>
        </section>
